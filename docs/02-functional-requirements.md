...
- 변형 규칙: Two-eyed로 배치한 칸은 **바로 다음 플레이어만** one-eyed jack으로 제거 불가

**수용 기준**
- [ ] 빈 칸만 선택 가능(단, 1-eye로 제거된 칸은 바로 다음 턴만 2-eye 배치 불가)
- [ ] 배치 후 자동 드로우
...
- [ ] 바로 다음 턴 플레이어는 two-eyed로 배치된 칸에 one-eyed jack 사용 불가
